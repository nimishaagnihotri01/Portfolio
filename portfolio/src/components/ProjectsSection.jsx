...
export const ProjectsSection=()=>{
    ...
    Each project reflects my interest in building clean, responsive, and user-friendly applications.</p>
                        ...
                        <div key={key} className="group bg-card rounded-lg overflow-hidden shadow-xs card-hover">
                            ...
                            <div className="flex justify-between items-center">
                                <div className="flex space-x-3">
                                    ...
                                    target="_blank" className="text-foreground/80 hover:text-primary transition-colors duration-300">{""} <ExternalLink size={20}/></a>
                ...
                <div className="text-center mt-12">
                    <a className="cosmic-button w-fit flex items-center mx-auto gap-2" target="_blank" href="https://github.com/nimishaagnihotri01">
